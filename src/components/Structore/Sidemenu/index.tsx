...
const Sidemenu = ({ sidemenuItems }: sidemenuProps) => {
  ...
  return (
    <nav
      ...
      className="sticky left-0 top-0 hidden max-h-screen w-[73px] overflow-hidden flex-col items-center justify-start gap-4 p-3 pt-5 lg:flex lg:hover:w-56 lg:items-start lg:p-1 lg:pt-5 duration-500 ease-in-out"
    >
