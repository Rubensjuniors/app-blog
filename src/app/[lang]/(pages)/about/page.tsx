      ...
      <section className="-mt-5 flex flex-col items-center gap-4 sm:mt-3 sm:px-4">
        <Card>
          ...
          <div className="flex flex-col gap-1 px-4 pb-4 sm:px-4 sm:pt-6">
            <h1 className="text-2xl font-bold sm:text-4xl">{t.blog.about.name}</h1>
            <span className="text-sm sm:text-lg">{t.blog.about.bio}</span>
          </div>
        </Card>

        <Card title={t.blog.about.about.title} classNames="p-4 flex flex-col items-start gap-2">
          <ShowMoreList 
          list={textAboutMe} 
          showIndice={1} 
          textbutton={{ 
            more: t.blog.about.about.showMore, 
            less: t.blog.about.about.showsLess 
          }} />
        </Card>
      </section>
    </>
