      ...
      <section className="-mt-5 flex flex-col items-center gap-4 sm:mt-3 sm:px-4">
        ...
        <Card title="Sobre" classNames="p-4 flex flex-col items-start gap-2">
          <p className="leading-5 sm:text-lg">
            ...
            programação. Tenho 19 anos e recentemente decidi me dedicar ao
            estudo de programação com o objetivo de me tornar um desenvolvedor
            front-end. Eu acredito que essa área combina perfeitamente com meus
            interesses e talentos, e estou animado para aprender e crescer nessa
            area. Embora ainda esteja no começo de minha jornada como
            programador, já tenho conseguido realizar algumas coisas com o pouco
            conhecimento que tenho adquirido. Acredito que, com muito esforço e
            dedicação, vou evoluir a cada dia e alcançar meus objetivos como
