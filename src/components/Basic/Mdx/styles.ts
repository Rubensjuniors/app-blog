...
export const MdxHeadingLevel2 = tw.h2`${({ className }) => className} mt-4 text-2xl font-bold sm:text-3xl`
export const MdxHeadingLevel3 = tw.h3`${({ className }) => className} mt-4 text-xl font-bold sm:text-2xl`
export const MdxHeadingLevel4 = tw.h4`${({ className }) => className} mt-4 text-xl font-bold`
export const MdxHeadingLevel5 = tw.h5`${({ className }) => className} mt-4 text-lg font-bold`
export const MdxHeadingLevel6 = tw.h6`${({ className }) => className} mt-4 text-base font-bold`
