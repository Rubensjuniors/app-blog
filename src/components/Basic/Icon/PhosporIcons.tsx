...
const PhosphorIcons = ({ id, iconSize = 24, classIcon }: iconProps) => {
  ...
  icons.set(
    'links_icon-phosphor',
    <Link size={iconSize} className={classIcon} />
  )
  icons.set(
    'pings_icon-phosphor',
    <Paperclip size={iconSize} className={classIcon} />
  )
  icons.set(
  ...
  icons.set(
    'list_icon-phosphor',
    <List size={iconSize} className={classIcon} />
  )
  icons.set(
    'home_icon-phosphor',
  ...
  icons.set(
    'caretUp-phosphor',
    <CaretUp size={iconSize} className={classIcon} />
  )
  icons.set(
    'caretDown-phosphor',
    <CaretDown size={iconSize} className={classIcon} />
  )
  icons.set(
    'star-phosphor',
    <Star size={iconSize} weight="fill" color="#FBFF00" className={classIcon} />
  )
  icons.set(
    'linkSimples-phosphor',
    <LinkSimple size={iconSize} className={classIcon} />
  )
  icons.set(
    'arrowSquareOut-phosphor',
    <ArrowSquareOut size={iconSize} className={classIcon} />
  )
  icons.set(
    'magnifyingGlass-phosphor',
    <MagnifyingGlass size={iconSize} className={classIcon} />
  )
  icons.set(
    'calendarBlank-phosphor',
    <CalendarBlank size={iconSize} className={classIcon} />
  )
  icons.set(
    'code-phosphor',
    <Code size={iconSize} color="#00B37E" className={classIcon} />
  )
  icons.set(
    'barbell-phosphor',
    <Barbell size={iconSize} color="#F75A68" className={classIcon} />
  )
  icons.set('copy-phosphor', <Copy size={iconSize} className={classIcon} />)
  icons.set(
    'arrowLeft-phosphor',
    <ArrowLeft size={iconSize} className={classIcon} />
  )
